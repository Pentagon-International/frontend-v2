...
const pathTitleMap: Record<string, string> = {
  ...
  "/job-profit-verification-approval": "Job Profit Verification Approval",
  "/job-reopen": "Reopen Job",
  "/bank-reconciliation/create": "Bank Reconciliation",
  "/bank-reconciliation": "Bank Reconciliation",
  "/master": "Masters",
  "/master/create-customer-pan": "Create Customer from PAN",
  "/master/create-vendor-pan": "Create Vendor from PAN",
  "/master/create-agent-pan": "Create Agent from PAN",
  "/master/customer-approval-status": "Customer Approval Status",
  "/master/vendor-approval-status": "Vendor Approval Status",
  "/master/agent-approval-status": "Agent Approval Status",
  "/master/approve-customers": "Approve Customers",
  "/master/approve-vendors": "Approve Vendors",
  "/master/approve-agents": "Approve Agents",
  "/master/create-customer": "Customer for Approval",
  "/master/create-vendor": "Vendor for Approval",
  "/master/create-agent": "Agent for Approval",
  "/master/agent": "Agent Master",
  "/reports": "Reports",
  "/help": "Help",
  "/collapse": "Collapse",
  "/settings": "Settings",
