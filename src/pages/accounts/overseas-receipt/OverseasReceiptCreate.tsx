    ...
    const pageTitle = pathname.includes("/reversal/view")
      ...
      : pathname.includes("/reversal/edit")
        ...
        : pathname.includes("/reversal/create")
          ...
          : pathname.includes("/overseas-receipt/view") || pathname.includes("/receipt/view")
            ? "View Overseas Receipt"
            : pathname.includes("/overseas-receipt/edit") || pathname.includes("/receipt/edit")
              ? "Edit Overseas Receipt"
              : pathname.includes("/overseas-receipt/create") || pathname.includes("/receipt/create")
