...
function FreightCreate() {
  ...
  const freightAuditInfo = useMemo(
    () =>
  ...
  const tariffSubmit = async () => {
    ...
    const tariffCharges = gridFormVal.tariff_charges.map((charge: any) => ({
      ...
      minimum:
        charge.minimum !== null && charge.minimum !== undefined
          ? String(charge.minimum)
          : null,
    }));
            ...
            <Box
              ...
              >
                <Grid px={"md"}>
                      ...
                      <Grid.Col span={isViewMode || isEditMode ? 6 : 12}>
                        <Group gap={6} wrap="nowrap">
                          ...
                          <EditPageAuditInfoIcon
                            ...
                            auditInfo={freightAuditInfo}
                            animateKey={editData?.id}
                            ariaLabel="Freight audit info"
                          />
                        </Group>
                      </Grid.Col>
                  ...
                  <Grid.Col span={{base: 12, sm: 6,md: 4, lg:3}}>
                    <Grid gutter="xs">
                      <Grid.Col span={mainForm.values.destination_code ? 10.5 : 12}>
                        <SearchableSelect
                          apiEndpoint={URL.portMaster}
                          label="Destination"
                          placeholder="Search by port code or name"
                              ...
                              .map(([unit, total]) => {
                                return (
                                  <Grid key={unit} columns={7} align="baseline">
                                    <Grid.Col span={!isViewMode ? 2.25 : 2.5}>
                                      <Group gap={"sm"} >
