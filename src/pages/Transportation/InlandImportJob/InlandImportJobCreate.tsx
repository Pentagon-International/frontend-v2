...
function InlandImportJobCreate() {
      ...
      try {
        ...
        if (savedMawbDetailsFromState) {
          mawbDetailsForm.setValues({
            ...
            job_date:
              savedMawbDetailsFromState.eta &&
              dayjs(savedMawbDetailsFromState.eta).isValid()
                ? dayjs(savedMawbDetailsFromState.eta).startOf("day").toDate()
                : savedMawbDetailsFromState.eta || null,
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // API call to create or update inland import job
      ...
      const { message, job: savedJob } = parseJobSaveResponse(
        saveResponse,
        `Inland Import Job ${mode === "edit" ? "updated" : "created"} successfully`,
      );
      ...
      <Group justify="space-between" align="center" mb="lg">
        <Group gap="md">
          <EditPageHeadingRow
            ...
            ariaLabel="Inland import job audit info"
            justify="flex-start"
          >
