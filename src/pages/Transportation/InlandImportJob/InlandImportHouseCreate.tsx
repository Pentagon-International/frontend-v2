  ...
  useEffect(() => {
    const updatedCharges = chargesForm.values.charges.map((charge) => {
      ...
      if (
        ...
        const calculatedAmount = clampCurrencyMoneyAmountBound(noOfUnit * amountPerUnit) ?? 0;
                          ...
                          onChange: (value: number | string | null) => {
                            ...
                            if (
                              ...
                              chargesForm.setFieldValue(
                                ...
                                clampCurrencyMoneyAmountBound(noOfUnit * currentCharge.amount_per_unit),
                              );
                            } else {
                            ...
                            if (
                              ...
                              chargesForm.setFieldValue(
                                ...
                                clampCurrencyMoneyAmountBound(noOfUnit * currentCharge.cost_per_unit),
                              );
                            } else {
                      ...
                      <FormNumberInput
                        ...
                        onChange={(value) => {
                          ...
                          if (amountPerUnit == null || amountPerUnit === 0 || currentCharge.no_of_unit == null || currentCharge.no_of_unit === 0) {
                            ...
                            chargesForm.setFieldValue(
                              `charges.${index}.amount`,
                              clampCurrencyMoneyAmountBound(currentCharge.no_of_unit * amountPerUnit),
                            );
                          }
                    ...
                    <FormNumberInput
                      ...
                      onChange={(value) => {
                        ...
                        if (
                          ...
                          chargesForm.setFieldValue(
                            `charges.${index}.total_cost`,
                            clampCurrencyMoneyAmountBound(currentCharge.no_of_unit * costPerUnit),
                          );
                        } else {
                          chargesForm.setFieldValue(`charges.${index}.total_cost`, null);
                        }
