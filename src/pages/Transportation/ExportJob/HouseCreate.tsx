    ...
    try {
      ...
      const housingData = {
        ...
        cargo_details: cargoDetails.map((c) => ({
          ...
          chargeable_weight: formatHouseCargoWeightForPayload(c.chargeable_weight),
                      ...
                      onChange={(value) => {
                        ...
                        if (
                          ...
                          chargesForm.setFieldValue(
                            ...
                            parseFloat(
                              (noOfUnit * currentCharge.unit_cost).toFixed(2),
                            ),
                          );
                        } else {
                          chargesForm.setFieldValue(
                      ...
                      onChange={(value) => {
                        ...
                        if (
                          ...
                          chargesForm.setFieldValue(
                            `charges.${index}.total_cost`,
                            parseFloat(
                              (currentCharge.no_of_unit * unitCost).toFixed(2),
                            ),
                          );
                        } else {
                          chargesForm.setFieldValue(
