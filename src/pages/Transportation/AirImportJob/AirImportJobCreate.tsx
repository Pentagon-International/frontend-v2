...
// Container schemas removed for Air Import Jobs
...
function AirImportJobCreate() {
  ...
  const navigateToHawbCreate = useCallback(
    (editIndex?: number, editData?: HAWBDetail) => {
      ...
      navigate("/air/import-job/house-create", {
        state: {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      ToastNotification({
        type: "success",
        message: `Air Import Job ${mode === "edit" ? "updated" : "created"} successfully`,
      });
    } catch (err) {
      ...
      >
        ...
        <Stepper.Completed>
          <Text size="lg" ta="center" c="dimmed" py="xl">
            Air Import Job {mode === "edit" ? "updated" : "created"}{" "}
            successfully!
          </Text>
        </Stepper.Completed>
      </Stepper>
...
export default AirImportJobCreate;
