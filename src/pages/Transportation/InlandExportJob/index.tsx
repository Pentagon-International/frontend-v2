...
type InlandExportJobListSummary = {
  status_counts?: {
    active?: number;
    closed?: number;
    cancel?: number;
...
type InlandExportJobListQueryResult = {
  data: InlandExportJobData[];
  total: number;
  summary?: InlandExportJobListSummary;
};

/** Inland Export Booking route column: origin_code_read → origin_code → origin_name (same for destination). */
function routeEndpointsFromAirExportJobRow(row: InlandExportJobData) {
  const ext = row as InlandExportJobData & {
...
function InlandExportJobMaster() {
              ...
              <>
                ...
                <Button
                  ...
                  onClick={() => {
                    ...
                    navigate("/inland/export-job/create");
                  }}
                >
                  Create New
                </Button>
                                ...
                                return (
                                  <ERPListJobActionMenu
                                    ...
                                    onView={() => {
                                      ...
                                      setStoreSearch(LIST_KEY, search);
                                      setShouldRestore(LIST_KEY, true);
                                      navigate(`/inland/export-job/view`, {
                                        state: {
                                          job: withInlandExportJobServiceFields(
                                            row as unknown as Record<
                                              string,
...
export default InlandExportJobMaster;
