...
function OceanImportBookingCreate() {
  ...
  const handleComplete = () => {
    console.log("Ocean import booking creation completed!");
          ...
          >
            ...
            >
              <EditPageHeadingRow
                ...
                ariaLabel="Ocean import booking audit info"
              ...
              >
                ...
                >
                  {isEditMode
                    ? "Edit Ocean Import Booking"
                    : "Create Ocean Import Booking"}
                </Text>
              </EditPageHeadingRow>
            </Box>
...
export default OceanImportBookingCreate;
