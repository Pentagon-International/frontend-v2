...
function FCLExportGenerationMaster() {
  ...
  const {
    ...
    queryKey: ["fcl-export-generation/filter/"],
    queryFn: async () => {
      try {
  ...
  const {
    ...
    queryKey: ["filteredFCLExportGeneration"],
    queryFn: async () => {
  ...
  const { data: searchData, isLoading: searchLoading } = useQuery({
    queryKey: ["fclExportGenerationSearch", debounced],
    queryFn: async () => {
  ...
  const clearAllFilters = async () => {
    try {
      ...
      queryClient.removeQueries({ queryKey: ["filteredFCLExportGeneration"] }); // Remove filtered data from cache
      ToastNotification({
        type: "success",
          ...
          {isDataLoading ? (
            <Center py="xl">
              <Stack align="center" gap="md">
                ...
                <Text c="dimmed">Loading FCL export generation...</Text>
              </Stack>
            </Center>
          ) : (
            <>
...
export default FCLExportGenerationMaster;
