...
const FCLExportGenerationStepper: React.FC<ExportShipmentStepperProps> = ({
  onStepChange,
  onComplete,
  initialData,
  isEditMode = false,
  ...
  // Auto-set service to FCL on mount
  useEffect(() => {
    if (!initialData || !initialData.service) {
      form.setFieldValue("service", "FCL");
    }
  }, []);
              ...
              <Grid.Col span={4}>
                <SearchableSelect
                  ...
                  onChange={(value, selectedData) => {
                    ...
                    form.setFieldValue("carrier_name", parseCarrierNameFromLabel(selectedData?.label || ""));
                  }}
...
export default FCLExportGenerationStepper;
