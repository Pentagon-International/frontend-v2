...
import FCLExportGenerationStepper from "./FCLExportGenerationStepper";

function FCLExportGenerationCreate() {
  ...
  const mapBookingDataToStepperFormat = (data: Record<string, unknown>) => {
    ...
    return {
      ...
      service: "FCL", // Always FCL for FCL Export Generation
  ...
  // Debug logging
  console.log("AirExportGenerationCreate - bookingData:", bookingData);
  console.log(
    "AirExportGenerationCreate - mappedBookingData:",
    mappedBookingData
  );
  ...
  const handleComplete = () => {
    console.log("FCL export generation creation completed!");
...
export default FCLExportGenerationCreate;
