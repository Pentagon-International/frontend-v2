...
import LCLExportGenerationStepper from "./LCLExportGenerationStepper";

function LCLExportGenerationCreate() {
  ...
  const mapBookingDataToStepperFormat = (data: Record<string, unknown>) => {
    ...
    return {
      ...
      service: "LCL", // Always LCL for LCL Export Generation
  ...
  const handleComplete = () => {
    console.log("LCL export generation creation completed!");
...
export default LCLExportGenerationCreate;
