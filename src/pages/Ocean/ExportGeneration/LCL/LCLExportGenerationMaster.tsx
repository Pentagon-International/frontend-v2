...
function LCLExportGenerationMaster() {
  ...
  const {
    ...
    queryKey: ["lcl-export-generation/filter/"],
    queryFn: async () => {
      try {
  ...
  const {
    ...
    queryKey: ["filteredLCLExportGeneration"],
    queryFn: async () => {
  ...
  const { data: searchData, isLoading: searchLoading } = useQuery({
    queryKey: ["lclExportGenerationSearch", debounced],
    queryFn: async () => {
  ...
  const clearAllFilters = async () => {
    try {
      ...
      queryClient.removeQueries({ queryKey: ["filteredLCLExportGeneration"] }); // Remove filtered data from cache
      ToastNotification({
        type: "success",
...
export default LCLExportGenerationMaster;
