...
/**
 * Same layout as {@link ByModeValueCard} with optional row click handling.
 * Kept separate so `ByModeValueCard.tsx` can remain unchanged.
 */
export function ClickableByModeValueCard({
  title,
  segments,
  rows,
  embeddedBelowFunnel,
  ...
  onRowClick?: (row: ModeLegendRow) => void;
}) {
            ...
            {rows.map((r) => (
              <Group
                ...
                style={{
                  ...
                  borderRadius: 6,
                  marginLeft: onRowClick ? -6 : undefined,
                  marginRight: onRowClick ? -6 : undefined,
                  padding: onRowClick ? "4px 6px" : undefined,
                }}
              >
