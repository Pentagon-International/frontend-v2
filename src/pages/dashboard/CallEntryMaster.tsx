        ...
        <Group justify="space-between" align="center" mb="md" wrap="nowrap">
          ...
          <Group gap="sm" wrap="nowrap">
            ...
            <Button
              ...
              color="#105476"
              onClick={() => {
                // Preserve current filter state when navigating to calendar
                const currentFilterState = {
                  filters: {
                    customer: appliedFilters.customer,
                    call_date: appliedFilters.call_date,
            ...
            <Button
              ...
              size="xs"
              onClick={() => {
                // Preserve current filter state when navigating to create
                const currentFilterState = {
                  filters: {
                    customer: appliedFilters.customer,
                    call_date: appliedFilters.call_date,
        ...
        {isLoading ? (
          <Center py="xl">
            <Stack align="center" gap="md">
              ...
              <Text c="dimmed">Loading call entries...</Text>
            </Stack>
          </Center>
        ) : (
          <>
            ...
            {/* Back to Dashboard Button - Centered below pagination */}
            {(location.state?.returnToDashboard ||
