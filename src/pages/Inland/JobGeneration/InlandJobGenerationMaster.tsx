...
const LIST_KEY = "INLAND_JOB_GENERATION_MASTER";
...
function InlandJobGenerationMaster() {
  ...
  const handleEdit = useCallback(
    (job: InlandJobData) => {
      ...
      navigate("/inland/job-generation/edit", {
        state: { job, mode: "edit" },
      });
    },
    [
  ...
  const handleView = useCallback(
    (job: InlandJobData) => {
      ...
      setStoreSearch(LIST_KEY, search);
      setShouldRestore(LIST_KEY, true);
      navigate("/inland/job-generation/view", {
        state: { job, mode: "view" },
      });
    },
    [
              ...
              <>
                ...
                <Button
                  ...
                  onClick={() => {
                    ...
                    setStoreSearch(LIST_KEY, search);
                    setShouldRestore(LIST_KEY, true);
                    navigate("/inland/job-generation/create", {
...
export default InlandJobGenerationMaster;
