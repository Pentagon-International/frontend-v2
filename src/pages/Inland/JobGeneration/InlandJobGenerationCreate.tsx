...
function InlandJobGenerationCreate() {
        ...
        <Tabs.Panel value="0">
          <Box mt="md">
            ...
            <Group justify="space-between" mt="xl">
              <Button variant="outline" color="#105476" leftSection={<IconArrowLeft size={16} />} onClick={() => navigate("/inland/job-generation")}>
                Back to List
              </Button>
              <Group gap="sm">
          ...
          <Box mt="md">
            ...
            <Group justify="space-between" mt="xl">
              <Button
                ...
                onClick={() => navigate("/inland/job-generation")}
              >
                Back to List
              </Button>
              <Group gap="sm">
...
export default InlandJobGenerationCreate;
