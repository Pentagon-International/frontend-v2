...
interface FormValues {
  ...
  /** Inland Export Booking only (root payload) */
  bill_no: string;
  bill_date: Date | null;
  iata: string;
  is_direct: boolean;
...
const InlandExportBookingStepper: React.FC<ExportShipmentStepperProps> = ({
  onStepChange,
  onComplete,
  initialData,
  isEditMode = false,
  ...
  const handleSubmit = async () => {
    try {
      ...
      // Navigate back to Inland Export Booking master page with refresh flag
...
export default InlandExportBookingStepper;
