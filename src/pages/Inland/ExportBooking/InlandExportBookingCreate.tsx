...
import InlandExportBookingStepper from "./InlandExportBookingStepper";
...
function InlandExportBookingCreate() {
  ...
  // Debug logging
  console.log("InlandExportBookingCreate - mode:", mode);
  console.log("InlandExportBookingCreate - jobData:", jobData);
  console.log("InlandExportBookingCreate - bookingData:", bookingData);
  console.log("InlandExportBookingCreate - mappedBookingData:", mappedBookingData);
  ...
  const handleComplete = () => {
    console.log("Inland Export Booking creation completed!");
    ...
    async (bookingMessage: string, bookingId: number) => {
      ...
      try {
        ...
        if (response?.success && bookingItem) {
          navigate("/inland/export-booking/edit", {
          ...
          >
            ...
            >
              <EditPageHeadingRow
                ...
                ariaLabel="Inland export booking audit info"
              ...
              >
                ...
                >
                  {isEditMode
                    ? "Edit Inland Export Booking"
                    : "Create Inland Export Booking"}
                </Text>
              </EditPageHeadingRow>
            </Box>
...
export default InlandExportBookingCreate;
