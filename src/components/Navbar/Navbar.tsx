...
const Navbar = ({
  ...
  // Keep Accounts expanded when on receipt or supplier-invoice routes
  useEffect(() => {
    if (location.pathname.startsWith("/receipt") || location.pathname.startsWith("/supplier-invoice")) {
